...
if (hasStaticRoot) {
  plugins.push(new CopyWebpackPlugin([{
    from: staticRoot,
    to: `${buildConfig.staticName}`
  }]))
}

// console.log('path.join(__dirname,)', path.join(__dirname, './my-loaders'))
/* resolveLoader: {
  modules: [path.join(__dirname, './my-loaders'), 'node_modules']
}, */
module.exports = {
  entry: './index.js',
  plugins: plugins,
